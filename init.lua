...
-- Show diagnostics in a floating window when the cursor rests on a line
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Custom: Searching for files in vim wiki
      vim.keymap.set('n', '<leader>si', function()
        builtin.live_grep {
          cwd = vim.fn.expand '~/vimwiki', -- directory to search in
          prompt_title = 'Wiki Search 🔍', -- custom title
        }
      end, { desc = '[S]earch W[I]ki' })
...
-- Auto-detect and preserve line endings
